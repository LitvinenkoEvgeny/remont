!function t(e, i, n) {
    ...
    1: [function (t, e, i) {
        (function (e) {
            var i = t("./../../bower_components/jquery/dist/jquery.js");
            t("gsap"), t("gsap-scrollToPlugin"), t("TimelineLite");
            var n = (t("scrollmagic"), t("./modules/_main-slider.js")), r = t("./modules/_category.js"), s = t("./modules/_canvas.js"), o = t("./modules/_modal.js"), a = t("./modules/_tabs.js"), l = t("./modules/_box.js"), u = t("./modules/_navbar.js"), h = t("./modules/_filter.js"), c = t("./modules/_back-button.js"), d = t("./modules/_scroll-scenes.js"), p = t("./modules/_form-submit.js");
            e.app = {}, app.scrollDisabled = !1, app.openedPopup = null, app.toparea = {}, app.catalog = {}, app.catalog2 = {}, app.initMap = t("./modules/_map.js"), app.openedObjects = [], app.util = {
                toCamelCase: function (t) {
                    return t.replace(/^([A-Z])|[\s-_](\w)/g, function (t, e, i, n) {
                    ...
                    app.scrollDisabled ? (app.rootContainer.off("mousewheel DOMMouseScroll", app.util.prevent), app.scrollDisabled = !1) : (app.rootContainer.on("mousewheel DOMMouseScroll", app.util.prevent), app.scrollDisabled = !0)
                }, transformNumber: function (t) {
                    return t.toString().length > 1 ? t : (parseInt(t, 10) + 100).toString().substr(1)
                    ...
                    return t = i("<div>").css({
                        ...
                        width: 100,
                        overflow: "scroll"
                    }).appendTo("body"), e = i("<div>").css({width: "100%"}).appendTo(t).outerWidth(), t.remove(), n = 100 - e, i("html").addClass("scrollbar-width-" + n), n
                }, getPlatform: function () {
                    var t = function (t) {
                        i("html").addClass(t)
                    };
                    -1 != navigator.appVersion.indexOf("Win") ? t("windows-os") : -1 != navigator.appVersion.indexOf("Mac") ? t("mac-os") : -1 != navigator.appVersion.indexOf("X11") ? t("unix-os") : -1 != navigator.appVersion.indexOf("Linux") && t("linux-os")
                }, openPopup: function (t) {
                    app.openedPopup = t, i(app.openedPopup).addClass("is-opened"), app.navbar.hidden(), app.mainSlider.pause()
                }, closePopup: function (t) {
                    i(app.openedPopup).removeClass("is-opened"), app.navbar.visible(), app.mainSlider.play(), app.openedPopup = null
                }, scrollTo: function (t, e, i) {
                    if (i || app.scrollDisabled !== !0) {
                        var n, r, s, o, a;
                        if (t.originalEvent.deltaY) n = Math.round(t.originalEvent.deltaY); else {
                            if (!t.originalEvent.detail)return;
                            n = 40 * t.originalEvent.detail
                        }
                        r = e || app.rootContainer, s = r.scrollTop(), o = s + n, a = .3, t.preventDefault(), TweenMax.to(r, a, {
                            scrollTo: {
                                y: o,
                                autoKill: !0
                            }, ease: Power1.easeOut
                ...
                i(".popup .object__slider").each(function (t, e) {
                    ...
                    n.on("init", function (t, e) {
                        ...
                        draggable: !1,
                        slide: ".object__slide",
                        prevArrow: n.parent().find(".object__slider-prev"),
                        nextArrow: n.parent().find(".object__slider-next"),
                        dots: !0,
                        swipe: !1,
                        respondTo: "slider",
                        arrows: !0,
                ...
                app.openedObjects.length > 0 && (i.each(app.openedObjects, function (t, e) {
                    e.close(!1)
                }), app.openedObjects = [])
            }, app.catalog.opened = !1, app.catalog.open = function (t, e, i) {
                app.catalog.opened || (app.util.toggleScroll(), app.modal.open(e, i), app.mainSlider.rollUp(), app.category.open(), app.morph.activate(t), app.navbar.hidden(), app.backButton.visible(1200), app.catalog.opened = !0)
            }, app.catalog.close = function () {
                app.catalog.opened && (app.util.toggleScroll(), app.modal.close(), app.mainSlider.rollDown(), app.morph.deactivate(), app.category.close(), app.navbar.visible(null, 800), app.backButton.hidden(), app.catalog.opened = !1, setTimeout(function () {
                    app.closeAllOpenedObjects()
                }, 700))
            }, app.catalog2.opened = !1, app.catalog2.open = function (t) {
                var e = t.data("morph-state"), i = t.data("content-index"), n = t.parents(".slick-center"), r = t.attr("href"), s = n.length ? 0 : app.category2.slickOptions.speed;
                app.catalog2.opened ? setTimeout(function () {
